...
public class CDEUtils {
    ...
    public static String getDataPath() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            dataDirectoryPath = Environment.getExternalStorageDirectory().getAbsolutePath() +
                    File.separator + "Android" + File.separator + "data" + File.separator + "com.cdeos.player" + File.separator + "files" + File.separator;
        }
    ...
    public static boolean isSdCardAvailable() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            dataDirectoryPath = Environment.getExternalStorageDirectory().getAbsolutePath() +
                    File.separator + "Android" + File.separator + "data" + File.separator + "com.cdeos.player" + File.separator + "files" + File.separator + "kantv";
        }
    ...
    @Deprecated
    //FIXME:will bring ANR issue sometimes
    ...
    public static void exitAPK(Activity activity) {
        //storeTEEConfigFile(activity.getApplicationContext());
        String exportedQRFilename = CDEUtils.getDataPath() + "kantv-zanshang.png";
        File tmpQRFile = new File(exportedQRFilename);
        if (tmpQRFile.exists()) {
            CDELog.j(TAG, "exported file already exist, delete it " + exportedQRFilename);
            tmpQRFile.delete();
        } else {
            CDELog.j(TAG, "exported file not exist" + exportedQRFilename);
        }
